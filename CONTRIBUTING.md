...
TODO(template) - update links to the repo

- Reporting a [bug](https://github.com/maksimryndin/rust-template/issues/new?assignees=&labels=bug&projects=&template=1-bugreport.yml)
- Taking part in [discussions](https://github.com/maksimryndin/rust-template/discussions)
- Submitting a [fix](https://github.com/maksimryndin/rust-template/pulls)
- Proposing new [features](https://github.com/maksimryndin/rust-template/issues/new?assignees=&labels=enhancement&projects=&template=2-feature-request.yml)
...
- Commit messages should be written in a short, descriptive manner and be prefixed with tags for the change type and scope (if possible) according to the [semantic commit](https://gist.github.com/joshbuchea/6f47e86d2510bce28f8e7f42ae84c716) scheme. For example, a new change to the `miden-mycrate` crate might have the following message: `feat(miden-mycrate): fix block-headers database schema`
